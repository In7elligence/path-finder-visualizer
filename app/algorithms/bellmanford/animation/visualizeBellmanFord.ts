...
export const visualizebellmanFords = async (
  state: IGridState,
  ...
  if (bombNode) {
    const purpleVisitedNodes = bellmanFord(newGrid, start, bombNode);
    ...
    const blueVisitedNodes = bellmanFord(newGrid, bombAsStart, finish);
    ...
    const visitedNodes = bellmanFord(newGrid, start, finish);
